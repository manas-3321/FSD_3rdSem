...
// 1) Custom Event Emitter ("greet" / "exit")
...
const HTML_FILE = path.join(__dirname, 'class.html');
...
// 3. EVENT LOOP DEMO
// Shows the order: sync code -> process.nextTick -> Promises -> setTimeout -> setImmediate
